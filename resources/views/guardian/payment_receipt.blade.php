...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('guardian.fees') }}" class="btn btn-outline-secondary">
...
<div class="card shadow-lg p-3" style="position: relative;">
    ...
    <div class="card-body" style="position: relative; z-index: 1;">
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-6">
                ...
                <table class="table table-bordered table-sm">
                    ...
                    <tr>
                        <th>Received By</th>
                        <td>{{ $payment->recordedBy->name ?? 'School Staff' }}</td>
                    </tr>
                </table>
            </div>
        </div>
        ...
        <div class="text-center mt-4">
            ...
            <a href="{{ route('guardian.fees') }}" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Back</a>
        </div>
