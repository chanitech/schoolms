...
@section('title', 'Edit Timetable Period')

@section('content_header')
    <h1>Edit Timetable Period</h1>
@stop
            ...
            <form action="{{ route('timetable-periods.update', $timetablePeriod) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror"
                           value="{{ old('name', $timetablePeriod->name) }}" required>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="time" name="start_time" id="start_time"
                               ...
                               value="{{ old('start_time', \Carbon\Carbon::parse($timetablePeriod->start_time)->format('H:i')) }}" required>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="time" name="end_time" id="end_time"
                               ...
                               value="{{ old('end_time', \Carbon\Carbon::parse($timetablePeriod->end_time)->format('H:i')) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="order_no" id="order_no" min="0" max="255"
                           ...
                           value="{{ old('order_no', $timetablePeriod->order_no) }}" required>
                ...
                <div class="form-group form-check">
                    <input type="checkbox" name="is_break" id="is_break" class="form-check-input" value="1" {{ old('is_break', $timetablePeriod->is_break) ? 'checked' : '' }}>
                    <label for="is_break" class="form-check-label">This is a break (Assembly, Short Break, Lunch, etc.) — not a teaching period</label>
                </div>

                <div class="form-group form-check">
                    <input type="checkbox" name="is_active" id="is_active" class="form-check-input" value="1" {{ old('is_active', $timetablePeriod->is_active) ? 'checked' : '' }}>
                    <label for="is_active" class="form-check-label">Active (counts toward timetable generation and capacity)</label>
                </div>

                <button type="submit" class="btn btn-success mt-2">Update Period</button>
