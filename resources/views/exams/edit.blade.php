                ...
                <div class="form-group">
                    <div class="form-check">
                        <input type="checkbox" name="include_in_term_final" id="include_in_term_final"
                               class="form-check-input" {{ old('include_in_term_final', $exam->include_in_term_final) ? 'checked' : '' }}>
                    ...
                    <div class="form-check">
                        <input type="checkbox" name="include_in_year_final" id="include_in_year_final"
                               class="form-check-input" {{ old('include_in_year_final', $exam->include_in_year_final) ? 'checked' : '' }}>
                    ...
                    <div class="form-check">
                        <input type="checkbox" name="is_terminal_exam" id="is_terminal_exam"
                               class="form-check-input" {{ old('is_terminal_exam', $exam->is_terminal_exam) ? 'checked' : '' }}>
                    ...
                    <div class="form-check">
                        <input type="checkbox" name="is_annual_exam" id="is_annual_exam"
                               class="form-check-input" {{ old('is_annual_exam', $exam->is_annual_exam) ? 'checked' : '' }}>
