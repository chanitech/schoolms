...
<div class="footer">
    Generated by: {{ $school->name ?? config('app.name') }} | {{ \Carbon\Carbon::now()->format('d M Y, H:i') }}
    &nbsp;|&nbsp; Powered by Shule360 — a Chani Technologies product · +255 713 209 535 · www.chanitech.co.tz
</div>
