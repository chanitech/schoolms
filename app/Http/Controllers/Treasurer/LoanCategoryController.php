<?php
// app/Http/Controllers/Treasurer/LoanCategoryController.php
...
class LoanCategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('treasurer.loan-categories.index')->with('success', 'Loan category created.');
    }
    ...
    public function update(Request $request, LoanCategory $loanCategory)
    {
        ...
        return redirect()->route('treasurer.loan-categories.index')->with('success', 'Loan category updated.');
    }

    public function destroy(LoanCategory $loanCategory)
    {
        // Prevent deletion if any loans exist
        if ($loanCategory->loans()->exists()) {
            return back()->with('error', 'Cannot delete category with existing loans.');
        }
        $loanCategory->delete();
        return redirect()->route('treasurer.loan-categories.index')->with('success', 'Loan category deleted.');
    }
}